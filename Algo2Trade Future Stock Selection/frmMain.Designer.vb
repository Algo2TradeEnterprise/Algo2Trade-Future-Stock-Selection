...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmbProcedure.Items.AddRange(New Object() {"ATR Based All Stock", "Trending Stocks", "User Given", "Pre Market Stock", "Intraday Volume Spike", "High Low ATR", "Intraday Volume Spike With SL"})
